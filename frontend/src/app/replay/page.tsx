  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-6 animate-in fade-in duration-500 h-[calc(100vh-2rem)] flex flex-col">
      ...
      <div className="flex justify-between items-center shrink-0">
        <div>
          <h1 className="text-3xl  font-bold text-primary mb-2">Mission Replay</h1>
      ...
      <div className="flex-1 flex flex-col min-h-0 space-y-6">
        ...
        <Card className="shadow-sm border shrink-0 border-border/50">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="flex items-center space-x-6 mb-8">
                ...
                <button 
                  ...
                  className="w-14 h-14 bg-primary/20 text-primary border border-border rounded-full flex items-center justify-center hover:bg-primary/30 transition-colors shadow-sm"
                >
              ...
              <div className="w-full relative px-4">
                <div className="h-2 w-full bg-muted rounded-full relative">
                  <div 
                    className="absolute top-0 left-0 h-full bg-primary rounded-full transition-all duration-300 shadow-sm" 
                ...
                <div className="flex justify-between text-xs text-muted-foreground mt-3 text-sm">
        ...
        <div className="grid grid-cols-2 gap-6 flex-1 min-h-0">
          ...
          <Card className="shadow-sm border h-full flex flex-col min-h-0 border-border/50">
            ...
            <CardContent className="p-4 overflow-y-auto flex-1 text-sm text-xs">
            ...
            <CardContent className="p-4 overflow-y-auto flex-1 space-y-3">
              <div className="text-xs flex flex-col pb-3 border-b border-border/30 opacity-50">
                <div className="flex justify-between items-center mb-1">
                  <span className="text-sm text-muted-foreground">T+00:07:10</span>
              ...
              <div className="text-xs flex flex-col pb-3 border-b border-border/30 opacity-70">
                <div className="flex justify-between items-center mb-1">
                  <span className="text-sm text-muted-foreground">T+00:07:12</span>
              ...
              <div className="text-xs flex flex-col pb-3 border-b border-border/30 shadow-sm rounded p-2 bg-primary/5 border border-border">
                <div className="flex justify-between items-center mb-1">
                  <span className="text-sm text-primary">T+00:07:15</span>
